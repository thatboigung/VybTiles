...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="bg-transparent sticky top-0 z-50">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between mt-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className={`w-10 h-10 flex items-center justify-center rounded-[8px] transition-all ${showShopMenu ? 'bg-white text-black' : 'bg-white/5 text-white hover:bg-white/10'}`}
              title="Shop"
            >
            ...
            {/* Shop Dropdown */}
            {showShopMenu && (
              <div className="absolute top-full right-0 mt-2 w-64 bg-[#1a1a1a] border border-white/10 rounded-xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-100 z-50">
          ...
          <div className="relative">
            <button
              ...
              className={`w-10 h-10 flex items-center justify-center rounded-[8px] transition-all ${showHelpMenu ? 'bg-white text-black' : 'bg-white/5 text-white hover:bg-white/10'}`}
              title="Help & Guide"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Help Dropdown */}
            {showHelpMenu && (
              <div className="absolute top-full right-0 mt-2 w-72 bg-[#1a1a1a] border border-white/10 rounded-xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-100 z-50 max-h-96 overflow-y-auto no-scrollbar">
